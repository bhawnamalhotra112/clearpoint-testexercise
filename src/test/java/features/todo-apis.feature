...
Feature: Get todo apis
  ...
  So that I can get update and delete todos
  ...
  Scenario Outline: API_ToDo_02 # Verify Todo GET request returns 200 todos.
    Given as a user I want to access todo Apis
    When I make GET request to the <Resource>
    Then I should get the response code <ResponseCode>
  ...
  @todos
  Scenario Outline: API_ToDo_03 # Verify user can get a todo.
    Given as a user I want to access todo Apis
    When I make GET request to the <Resource>
    Then I should get the response code <ResponseCode>
  ...
  @todos
  Scenario Outline: API_ToDo_05 # Update/PUT a todo verify it's updated sucessfully.
  ...
  Scenario Outline: API_ToDo_06 # Verify user can Delete a todo.
